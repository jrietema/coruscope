    ...
    var tpl = {
        ...
        "image": function(locale, options) {
            ...
            return "<li>" +
                ...
                "<label for=\"original_image_resolution\"><input type=\"radio\" class=\"original_image_resolution\" name=\"image_resolution\" value=\"original\"/>original Resolution</label>" +
                "</div></form>" +
                "</div>" +
                ...
                "<a href='#' class='insert_image_save btn btn-primary'>" + locale.image.insert + "</a>" +
                "</div>" +
                "</div>" +
